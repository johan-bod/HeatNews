    ...
    <section className="py-20 px-6 relative">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {/* Sign Up Card */}
          <Card className="bg-slate-800/30 backdrop-blur-sm border-slate-700/50 hover:border-purple-500/50 transition-all duration-300">
            <CardHeader className="text-center pb-4">
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-center text-sm text-slate-400">
                By signing up, you agree to our <a href="#" className="text-purple-400 hover:text-purple-300 transition-colors">Terms</a>
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-slate-800/20 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/30">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-sm text-slate-300">
              <div>
                <div className="text-blue-400 font-semibold mb-1">Custom Locations</div>
                <div>Set multiple locations for comprehensive coverage</div>
              </div>
              <div>
                <div className="text-purple-400 font-semibold mb-1">Topic Preferences</div>
                <div>Choose categories that matter most to you</div>
              </div>
              <div>
                <div className="text-cyan-400 font-semibold mb-1">Smart Notifications</div>
